...
from utils import contrast_normalization, stretchlim
...
min_int_red, max_int_red = stretchlim(red_ch)
min_int_green, max_int_green = stretchlim(green_ch)
min_int_blue, max_int_blue = stretchlim(blue_ch)

red_ch_norm = contrast_normalization(red_ch, min_int_red, max_int_red)
green_ch_norm = contrast_normalization(green_ch, min_int_green, max_int_green)
blue_ch_norm = contrast_normalization(blue_ch, min_int_blue, max_int_blue)
